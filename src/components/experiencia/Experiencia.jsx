...
export const Experiencia = () => {
  const experiencia = [
    {
      title: "Mi-Pedido (demo)",
      description:
        "He desarrollado una página web para una distribuidora local con el objetivo de mejorar la experiencia de compra de los clientes y optimizar el proceso de pedidos. La página web cuenta con las siguientes funcionalidades.",
      funciones: [
      ...
      <div className="experienciaContainer">
        ...
        {experiencia.map(
          ({
            ...
            <div key={title} className="containerExperiencia">
