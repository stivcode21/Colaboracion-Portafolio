...
export const Proyectos = () => {
  ...
  const splideOptions = {
    ...
    pagination: true,     // Oculta los indicadores de paginación (puntos debajo del carrusel)
    breakpoints: {         // Configuración de diseño adaptable (responsive) para diferentes tamaños de pantalla.
      1200: { perPage: 1 },  // A partir de 1200px, muestra 3 elementos por página.
      991: { perPage: 1 }, // A partir de 991px, muestra 2.3 elementos por página.
      768: { perPage: 1 },   // A partir de 768px, muestra 2 elementos por página.
      500: { perPage: 1 }, // A partir de 500px, muestra 1.3 elementos por página.
    ...
    <>
      ...
      <div className="slider-container">
        <Splide options={splideOptions}>
          {proyectos.map(
            ({ title, description, link, github, funciones, image, tags }, i) => (
              <SplideSlide key={i}>
                <section
                  id="proyectos"
                  key={title}
