  ...
  return (
    <section id="sobreMi" className="sobreMi">
      ...
      <p className="sobreMiP" translate="no">
        ...
        trabajando en proyectos personales que me permiten aplicar y expandir
        mis conocimientos. Creo firmemente que la mejor manera de aprender es
        haciendo, y siempre estoy buscando nuevas oportunidades para desafiarme
        a mí mismo.
      </p>
      <p className="sobreMiP" translate="no">
