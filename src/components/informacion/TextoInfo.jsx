    ...
    <>
      <section id="inicio">
        <div id="textoInicio" className="textoInfo">
          <p className="pInfo">
          ¡Hola! Soy Alan, un desarrollador front-end capaz de crear experiencias web cautivadoras y funcionales. Con una sólida formación en tecnologías como HTML, CSS, JavaScript, React, entre otras. Junto con un ojo meticuloso para el diseño y la usabilidad, me esfuerzo por llevar las ideas desde la concepción hasta la realidad digital.
          </p>
          <p className="pInfo">
